...
class ServiceController extends Controller
{
    ...
    public function index($uid)
    {
        ...
        return view('service::services.index', $this->data);
    }
    ...
    public function create($uid)
    {
        ...
        return view('service::services.create', $this->data);
    }
    ...
    public function store(Request $request, $uid)
    {
        ...
        $service->kind = $request->input('kind');
        $service->user_id = $user->_id;
        $service->code = intval(rand(10, 99).time());
        $service->version = 1;
        $service->save();
    ...
    public function show($id)
    {
        ...
        return view('service::services.show', $this->data);
    }

    public function qr($id){
        $this->data['service'] = Service::find($id);

        return view('service::services.qr', $this->data);
    }
    ...
    public function portConnect($sid, $port_system_name){
        ...
        return view('service::services.ports.connect', $this->data);
    }
    ...
    public function commands($sid){
        ...
        return view('service::commands.index', $this->data);
    }

    public function createCommand($sid){
        $this->data['service'] = Service::find($sid);

        return view('service::commands.create', $this->data);
    }
    ...
    public function editCommand($sid, $cid){
        ...
        return view('service::commands.edit', $this->data);
    }
