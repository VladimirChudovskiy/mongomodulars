...
class UserController extends BaseController
{
    ...
    {
        $user_model = new User();
        $this->data['users'] = $user_model->getWithFilter();

        return view('acl::users.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('acl::users.create', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('acl::users.edit', $this->data);
    }
